...
def welcome():
    ...
    return (
        ...
        f"<br/>"
        f"<strong>/api/v1.0/period?begin_date=yyyy-mm-dd</strong><br/>"
        f"<strong>/api/v1.0/period?end_date=yyyy-mm-dd</strong><br/><br/>"
        f"<strong>or combinations of begin_date and end_date parameters</strong><br/><br/>"
